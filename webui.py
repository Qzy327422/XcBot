        ...
        try:
            ...
            with tempfile.TemporaryDirectory(prefix="xcbot_update_") as tmp:
                ...
                if tag_name:
                    ...
                    download_candidates.append(f"https://ghp.ci/https://github.com/{GITHUB_REPO}/archive/refs/tags/{raw_tag}.zip")
                    download_candidates.append(f"https://ghproxy.net/https://github.com/{GITHUB_REPO}/archive/refs/tags/{raw_tag}.zip")
                    download_candidates.append(f"https://github.com/{GITHUB_REPO}/archive/refs/tags/{raw_tag}.zip")
